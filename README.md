...
Phenotypes come from Grimm et al. (2017) and Zhao et al. (2007, compiled by Atwell et al. 2010).
...
⚠️ The two blocks come from independent experiments (same genotypes but different plants): 944 accessions for the easyGWAS traits, 112 for the vernalization series. Both are accession means. Flowering time is right-censored at 125 days.
